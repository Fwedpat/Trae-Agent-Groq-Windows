...
class _BashSession:
    ...
    def __init__(self):
        ...
        # Use appropriate bash command on Windows if available
        if os.name == 'nt':
            # assume 'bash' (e.g., from Git Bash or WSL) is in PATH
            self.command = 'bash'
        else:
    ...
    async def start(self):
        ...
        if os.name != 'nt':  # Only use preexec_fn on Unix-like systems
